...
const REPO_URL = 'https://github.com/templeandwebster/webster-internal';
...
function websterComponentFromJSX(node, context) {
  ...
  if (importDetails == null || importDetails.source !== '@tpw/webster') {
    return false;
  }
