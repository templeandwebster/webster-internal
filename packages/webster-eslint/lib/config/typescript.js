...
const tpwEsnextConfig = require('./esnext');
...
module.exports = [
  ...
  importTypescriptConfig.configs.typescript,
  {
    ...
    rules: {
      ...
      '@tpw/no-fully-static-classes': 'off',
      ...
      strict: 'off',
      '@tpw/prefer-early-return': 'off',
      'array-callback-return': 'off',
      'getter-return': 'off',

      // Prefer TypeScript enums be defined using Pascal case
      '@tpw/typescript-prefer-pascal-case-enums': 'error',
      // Prefer TypeScript enums be defined using singular names
      '@tpw/typescript-prefer-singular-enums': 'error',
