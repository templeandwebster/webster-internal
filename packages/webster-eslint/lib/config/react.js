...
module.exports = [
  {
    ...
    rules: {
      ...
      '@tpw/react-hooks-strict-return': 'error',
      '@tpw/react-initialize-state': 'error',
      '@tpw/react-no-multiple-render-methods': 'error',
      '@tpw/react-prefer-private-members': 'error',
      '@tpw/react-require-autocomplete': 'error',
      '@tpw/react-type-state': 'error',
      '@tpw/jsx-no-complex-expressions': 'error',
      '@tpw/jsx-no-hardcoded-content': 'error',
      '@tpw/jsx-prefer-fragment-wrappers': 'error',
