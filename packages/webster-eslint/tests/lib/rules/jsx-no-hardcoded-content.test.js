...
ruleTester.run('jsx-no-hardcoded-content', rule, {
  valid: [
    ...
    },
    {
      code: `
        ...
        <Webster.MyComponent>Content</Webster.MyComponent>
      `,
      filename: fixtureFile('basic-app/app/sections/MySection/MySection.js'),
      options: [
        {
    ...
    {
      code: `
        import {MyComponent} from '@tpw/webster';
  ...
  invalid: [
    ...
    },
    {
      ...
      errors: errorsFor('Webster.MyComponent', 'children'),
    },
    {
      code: `
        import * as Webster from '@tpw/webster';
        <Webster.MyComponent>{42}</Webster.MyComponent>
      `,
      filename: fixtureFile('basic-app/app/sections/MySection/MySection.js'),
      options: [
        {
